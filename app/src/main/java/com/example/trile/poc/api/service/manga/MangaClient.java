...
import com.example.trile.poc.helper.Objects;
...
public class MangaClient {
    ...
    public static void getAllMangaItems(final MutableLiveData<List<MangaItemEntity>> downloadedMangaItems) {
        Call<MangaResponse> call = mIMangaClient.getAllMangaItems(Constants.GET_ALL_MANGAS_MSID_CODE, Constants.GET_ALL_MANGAS_COUNTRY_CODE);
